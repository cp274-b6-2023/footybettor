                ...
                if ("Enter".equals(command)){
                    ...
                    if (checknumber(userChoice)) {
                        ...
                        if (choice_final > 0 && choice_final < CreateFixture.fixtureList.size()) {
                            ...
                            JLabel label = new JLabel("Choose a type of odds: ");
                            f.add(label);
                            JLabel label2 = new JLabel("1. Decimal odds");
                            f.add(label2);
                            JLabel label3 = new JLabel("2. American odds");
                            f.add(label3);
                            ...
                            d_odd.addActionListener(new AbstractAction() {
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    ...
                                    if ("1".equals(command2)) {
                                        ...
                                        JLabel label = new JLabel("1. Home Team " + team1choice + " wins. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[0]);
                                        newFrame.add(label);
                                        JLabel label2 = new JLabel("2. Away Team " + team2choice + " wins. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[1]);
                                        newFrame.add(label2);
                                        JLabel label3 = new JLabel("3. This is a draw. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[2]);
                                        newFrame.add(label3);
                        ...
                        d_odd.addActionListener(new AbstractAction() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                if ("1".equals(command2)) {
                                    ...
                                    JLabel label = new JLabel("1. Home Team " + homeTeam + " wins. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[0]);
                                    newFrame.add(label);
                                    JLabel label2 = new JLabel("2. Away Team " + awayTeam + " wins. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[1]);
                                    newFrame.add(label2);
                                    JLabel label3 = new JLabel("3. This is a draw. Odds: " + typechoice[0].returnodd(odd.findOdd(userchoice))[2]);
                                    newFrame.add(label3);
                                    //JLabel label4 = new JLabel("Pick one to bet!" + System.lineSeparator());
