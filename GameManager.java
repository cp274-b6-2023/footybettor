...
public class GameManager {
    ...
    public void startBet(User user) throws IOException {
        ...
        Object[] options = { "Enter game number", "Enter team names manually" };
        int response = JOptionPane.showOptionDialog(null, "Decide which way to pick a game to bet. \nClick one of the following buttons.", "Start to bet", JOptionPane.YES_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (response == 0) {
            //enter game number
                                ...
                                t1win.addActionListener(new AbstractAction() {
                                    ...
                                    public void actionPerformed(ActionEvent e) {
                                        ...
                                        if ("1".equals(command2)){
                                            ...
                                            int userresult = 1;
                                            while(true){
                                                String wager = JOptionPane.showInputDialog("Enter wager:");
